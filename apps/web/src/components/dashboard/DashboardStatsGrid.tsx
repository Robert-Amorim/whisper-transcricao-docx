  ...
  return (
    <section className="grid grid-cols-3 gap-6">
      <article className="rounded-xl border border-slate-200 bg-white p-6 dark:border-clarity-border dark:bg-clarity-surface">
        ...
        <div className="mt-4 h-1.5 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-clarity-surface-strong">
      ...
      <article className="rounded-xl border border-slate-200 bg-white p-6 dark:border-clarity-border dark:bg-clarity-surface">
        ...
        <button
          ...
          className="mt-4 min-h-0 w-full rounded-lg bg-slate-100 py-2 text-xs font-bold uppercase tracking-wider transition-all hover:bg-primary hover:text-white dark:bg-clarity-surface"
        >
          Adicionar Créditos
        </button>
      </article>
