...
function getNavClass(isActive: boolean) {
  ...
  return "flex items-center gap-3 rounded-lg px-3 py-2.5 text-slate-600 transition-colors hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800";
}
  ...
  return (
    <aside className="flex w-64 flex-shrink-0 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-background-dark">
      ...
      <div className="border-t border-slate-200 p-4 dark:border-slate-800">
        ...
        >
          <div
            className="h-9 w-9 shrink-0 overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700"
